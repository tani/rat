...
import errorFlagsHSource from "./libtexprintf/src/errorflags.h" with { type: "file" };
import errorMessagesHSource from "./libtexprintf/src/errormessages.h" with { type: "file" };
