...
import boxesCSource from "./src/boxes.c" with { type: "file" };
import boxesHSource from "./src/boxes.h" with { type: "file" };
import drawboxCSource from "./src/drawbox.c" with { type: "file" };
import drawboxHSource from "./src/drawbox.h" with { type: "file" };
import drawcharsHSource from "./src/drawchars.h" with { type: "file" };
import errorCSource from "./src/error.c" with { type: "file" };
import errorHSource from "./src/error.h" with { type: "file" };
import errorFlagsHSource from "./src/errorflags.h" with { type: "file" };
import errorMessagesHSource from "./src/errormessages.h" with { type: "file" };
import lexerCSource from "./src/lexer.c" with { type: "file" };
import lexerHSource from "./src/lexer.h" with { type: "file" };
import mapUnicodeHSource from "./src/mapunicode.h" with { type: "file" };
import parseDefHSource from "./src/parsedef.h" with { type: "file" };
import parserCSource from "./src/parser.c" with { type: "file" };
import parserHSource from "./src/parser.h" with { type: "file" };
import stringUtilsCSource from "./src/stringutils.c" with { type: "file" };
import stringUtilsHSource from "./src/stringutils.h" with { type: "file" };
import texprintfCSource from "./src/texprintf.c" with { type: "file" };
import unicodeBlocksHSource from "./src/unicodeblocks.h" with { type: "file" };
